#!/usr/bin/env python3
"""Qualify allied-pressure switch fixtures against unchanged, frozen engine objects."""
import argparse
import json
import os
...
def main():
    ...
    source = exp.ROOT / 'test/MaximaPressureSwitchBehaviorTest.cpp'
    ...
    exp.atomic(args.output/'PASS.json', {
        ...
        'validated_switches': ['teamplay.pressure_coordination_enabled'], 'cases': 16,
        'checks': ['paired on/off', 'nearby allied warrior eligibility', 'inactive-world silence',
                   'allied pressure score changes selected raid target and resulting mission orders'],
        'parent_disabled': 'tactics.enabled and teamplay.enabled independently gate coordination',
    ...
    print('teamplay.pressure_coordination_enabled: sixteen behavioral cases PASS')
