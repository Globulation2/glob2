#!/usr/bin/env python3
"""Qualify teamplay switch fixtures against unchanged, frozen engine objects."""
import argparse
import json
import os
...
def main():
    ...
    source = exp.ROOT / 'test/MaximaTeamplaySwitchBehaviorTest.cpp'
    ...
    exp.atomic(args.output/'PASS.json', {
        ...
        'validated_switches': ['teamplay.enabled', 'teamplay.defense_enabled'], 'cases': 16,
        'checks': ['paired parent/child on/off', 'hostile threat eligibility', 'tactics-parent suppression',
                   'inactive-world silence', 'relief mission, allied target and flag orders'],
        'parent_disabled': 'tactics disabled suppresses relief; teamplay disabled suppresses child defense',
    ...
    print('teamplay.enabled and teamplay.defense_enabled: 16 behavioral cases PASS')
