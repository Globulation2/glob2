...
PARAMETER_SETS = {
    ...
    "economy": (
        ...
        "staffing.inn_level1_low_corn_threshold",
        "staffing.inn_level2_low_corn_threshold",
        "staffing.inn_level3_low_corn_threshold",
        "staffing.inn_level1_normal_workers",
        "staffing.inn_level2_normal_workers",
        "staffing.inn_level3_normal_workers",
        "staffing.inn_level1_low_corn_workers",
        "staffing.inn_level2_low_corn_workers",
        "staffing.inn_level3_low_corn_workers",
    ...
    "farming": (
        ...
        "scheduling.barrier_topology_interval_ticks",
        "military.tower_barrier_bonus",
    ),
    "placement": (
