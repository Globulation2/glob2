#!/usr/bin/env python3
"""Qualify amphibious defense switch fixtures against unchanged, frozen engine objects."""
import argparse
import json
import os
...
def main():
    ...
    source = exp.ROOT / 'test/MaximaAmphibiousDefenseSwitchBehaviorTest.cpp'
    ...
    exp.atomic(args.output/'PASS.json', {
        ...
        'validated_switches': ['military.preemptive_amphibious_enabled'], 'cases': 8,
        'checks': ['paired on/off', 'trained swimmer eligibility across a water gap', 'inactive-world silence',
                   'amphibious choke selection, desired guard tiles and management orders'],
        'parent_disabled': 'military.preemptive_defense_enabled=false blocks amphibious guard zones',
    ...
    print('military.preemptive_amphibious_enabled: eight behavioral cases PASS')
