#!/usr/bin/env python3
"""Qualify additional switch fixtures against unchanged, frozen engine objects."""
import argparse
import json
import os
...
def main():
    ...
    source = exp.ROOT / 'test/MaximaAdditionalSwitchBehaviorTest.cpp'
    ...
    exp.atomic(args.output/'PASS.json', {
        ...
        'validated_switches': ['defense.reactive.enabled'], 'cases': 8,
        'checks': ['paired on/off', 'invader and attacked-worker eligibility',
                   'inactive-world silence', 'positive flag staffing and threat coverage'],
        'parent_disabled': 'not applicable: independent reactive defense switch',
    ...
    print('defense.reactive.enabled: eight behavioral cases PASS')
