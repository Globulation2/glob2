...
MODES = {'farming.enabled': 'FS 30k', 'recon.enabled': 'FS 30k', 'tactics.enabled': 'CP+END', 'colonization.enabled': 'FS+CP', 'defense.reactive.enabled': 'CP+END', 'military.preemptive_defense_enabled': 'CP+END', 'military.explorer_defense_enabled': 'CP+END', 'economy.food_service_safeguards_enabled': 'FS 30k', 'upgrades.enabled': 'FS+CP', 'emergencies.food_enabled': 'CP+END', 'emergencies.colony_enabled': 'CP+END', 'postures.recover_enabled': 'SH+CP', 'postures.defend_enabled': 'SH+CP+END', 'postures.expand_enabled': 'SH+CP', 'postures.develop_enabled': 'SH+CP', 'postures.mobilize_enabled': 'SH+CP+END', 'postures.campaign_enabled': 'SH+CP+END', 'postures.finish_enabled': 'SH+CP+END', 'economy.large_economy_adaptation_enabled': 'FS+CP', 'economy.amphibious_network_maintenance_enabled': 'CP', 'economy.worker_birth_throttle_enabled': 'CP', 'repairs.enabled': 'CP+END', 'military.warrior_training_backlog_throttle_enabled': 'CP', 'placement.food_preservation_enabled': 'SH+CP', 'placement.defensive_siting_enabled': 'SH+CP+END', 'placement.artery_routing_enabled': 'SH+CP', 'tactics.siege_enabled': 'CP+END', 'tactics.dig_out_enabled': 'CP+END', 'raiding.enabled': 'CP+END', 'explorer_campaign.enabled': 'CP+END', 'recon.scouting_missions_enabled': 'CP', 'recon.force_memory_enabled': 'CP', 'farming.farm_protection_enabled': 'SH+CP', 'farming.resource_preserving_circulation_enabled': 'FS+CP', 'farming.maintenance_clearing_enabled': 'CP', 'farming.proactive_clearing_enabled': 'CP', 'economy.swarm_retirement_enabled': 'CP', 'military.preemptive_amphibious_enabled': 'CP+END', 'placement.spacing_compactness_enabled': 'SH+CP', 'tactics.failed_target_quarantine_enabled': 'CP+END', 'fruit.enabled': 'CP', 'recon.economic_watch_enabled': 'CP', 'farming.wheat_invasion_clearing_enabled': 'FS+CP', 'farming.wood_firebreak_enabled': 'FS+CP', 'food.enabled': 'FS 30k', 'food.target_capping_enabled': 'SH+CP', 'food.retirement_enabled': 'CP'}
LOOKS = (40, 80, 160, 320)
MAX_BLOCKS = 320
ALPHA = .05
...
def horizon(key):
    ...
    return 10000 if key in {"economy.worker_birth_throttle_enabled"} else 20000
