#!/usr/bin/env python3
"""Qualify preemptive defense switch fixtures against unchanged, frozen engine objects."""
import argparse
import json
import os
...
def main():
    ...
    source = exp.ROOT / 'test/MaximaPreemptiveSwitchBehaviorTest.cpp'
    ...
    exp.atomic(args.output/'PASS.json', {
        ...
        'validated_switches': ['military.preemptive_defense_enabled'], 'cases': 4,
        'checks': ['paired on/off', 'trained-warrior eligibility', 'inactive-world silence',
                   'choke selection, desired guard tiles and issued management orders'],
        'parent_disabled': 'not applicable: independent preemptive defense switch',
    ...
    print('military.preemptive_defense_enabled: four behavioral cases PASS')
