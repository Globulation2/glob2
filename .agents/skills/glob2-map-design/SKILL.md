...
- Read [the tuning playbook](references/tuning-playbook.md) before the first AI game and whenever a colony stalls, starves or never reaches a rival. It records the recurring opening-economy, catchment, fairness-model and route-protection defects the September 2026 batch of sixteen generators hit, the remedies each chose, and the rotation-tournament loop that measures them.
