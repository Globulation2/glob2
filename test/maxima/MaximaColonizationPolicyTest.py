...
class MaximaColonizationPolicyTest(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.placement = (ROOT / "src/ai/maxima/AIMaximaPlacement.cpp").read_text()
        cls.placement_header = (ROOT / "src/ai/maxima/AIMaximaPlacement.h").read_text()
    ...
    def test_colonization_decision_state_is_saved(self) -> None:
        ...
        for durable in (
            ...
            self.assertIn(durable, self.state)
        self.assertIn("development_planner.load(stream, versionMinor)", self.state)
