...
class MaximaFarmingPolicyTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.core = (ROOT / "src/ai/maxima/AIMaxima.cpp").read_text()
        cls.state = (ROOT / "src/ai/maxima/AIMaximaState.cpp").read_text()
        cls.policy = (ROOT / "src/ai/maxima/AIMaximaFarmingPolicy.cpp").read_text()
        cls.source = cls.policy + "\n" + cls.core
        cls.primitive = (ROOT / "src/ai/maxima/AIMaximaFarming.cpp").read_text()
    ...
    def test_cache_is_private_and_not_serialized(self):
        ...
        director = self.state[self.state.index("void Maxima::saveDirector"): ]
