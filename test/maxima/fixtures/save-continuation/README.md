...
the current AI policy. The army-capacity change first alters these records at tick
30253; its baseline was regenerated on macOS. The original v115 checkpoint is
retained to keep testing older-save loading. The test also saves at tick 30256,
