...
def main():
    ...
    for i in range(272):
        ...
        records.append(dict(id=f'terrain{i}',width=w,height=h,scale=4,recipe='shared-material rugged corner masks v2; generated grass blades',layers=[dict(file=name,role='base',sha256=sha(OUT/name),source_sha256=sha(source))]))
