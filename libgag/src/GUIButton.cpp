...
namespace GAGGUI
{
    ...
    void TextButton::paintResponsive()
    {
        ...
        Style::style->drawTextButtonBackground(surface, x, y, w, h, getNextHighlightValue());
        fontPtr->pushStyle(GAGCore::Font::Style(GAGCore::Font::STYLE_NORMAL,Style::style->textColor));
