...
The [main plan](https://github.com/Globulation2/glob2/blob/evidence/lava-shield/docs/map-generators/evidence/lava-shield/plan.json) contains 424 jobs across 16
...
controls. The [disjoint held-out plan](https://github.com/Globulation2/glob2/blob/evidence/lava-shield/docs/map-generators/evidence/lava-shield/heldout-plan.json)
...
map-generation failure. The [final plan](https://github.com/Globulation2/glob2/blob/evidence/lava-shield/docs/map-generators/evidence/lava-shield/final-plan.json)
repeats the exact 504 requests on the rebuilt executable. The
[per-job final CSV](https://github.com/Globulation2/glob2/blob/evidence/lava-shield/docs/map-generators/evidence/lava-shield/final-jobs.csv) retains every seed,
dimension, colony count, control, outcome, quality, construction fallback and
report status. The [summary](https://github.com/Globulation2/glob2/blob/evidence/lava-shield/docs/map-generators/evidence/lava-shield/final-summary.json) groups
outcomes by shape and variant; the [paired comparison](https://github.com/Globulation2/glob2/blob/evidence/lava-shield/docs/map-generators/evidence/lava-shield/paired-comparison.json)
...
dropped records or invalid values. The [raw minimum map report](https://github.com/Globulation2/glob2/blob/evidence/lava-shield/docs/map-generators/evidence/lava-shield/final-minimum-report.json),
[dense extreme](https://github.com/Globulation2/glob2/blob/evidence/lava-shield/docs/map-generators/evidence/lava-shield/final-dense-high-report.json), and
[rescued seed](https://github.com/Globulation2/glob2/blob/evidence/lava-shield/docs/map-generators/evidence/lava-shield/final-rescued-starter-report.json)
show the full metrics and internal decisions behind selected rows.
The [rectangle's complete native report](https://github.com/Globulation2/glob2/blob/evidence/lava-shield/docs/map-generators/evidence/lava-shield/maps/rectangle-512x256.json.gz)
is attached in compressed form beside its playable map.
The shared framework's complete [typed event rows](https://github.com/Globulation2/glob2/blob/evidence/lava-shield/docs/map-generators/evidence/lava-shield/final-telemetry-records.csv.gz)
and [numeric final-map metric rows](https://github.com/Globulation2/glob2/blob/evidence/lava-shield/docs/map-generators/evidence/lava-shield/final-map-metrics.csv.gz)
...
Its exact [source identity](https://github.com/Globulation2/glob2/blob/evidence/lava-shield/docs/map-generators/evidence/lava-shield/fallback-source-identity.json)
...
[startup error and host versions](https://github.com/Globulation2/glob2/blob/evidence/lava-shield/docs/map-generators/evidence/lava-shield/worker-startup.json)
...
[compressed playable maps and JSON reports](https://github.com/Globulation2/glob2/blob/evidence/lava-shield/docs/map-generators/evidence/lava-shield/maps/).
The [checksums](https://github.com/Globulation2/glob2/blob/evidence/lava-shield/docs/map-generators/evidence/lava-shield/preview-checksums.json) identify each
