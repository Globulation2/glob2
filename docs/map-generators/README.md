...
See [the rectangular-map review](RECTANGULAR_MAP_REVIEW.md) for preview/start-coordinate fixes, rectangular regression coverage, and remaining seeded placement failures.
