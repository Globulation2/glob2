...
- [Handoff for the next chat](HANDOFF.md): current checkpoint, constraints, tests and unfinished work.
...
- [Verification status](status.md): current evidence, limitations, and next gates.

Pinch zoom is deferred while the basic platform architecture is completed.
