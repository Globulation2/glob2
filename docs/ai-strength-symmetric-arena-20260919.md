Historical Symmetric Arena-only cohort; superseded for UI ratings by [the broad duel tournament](ai-strength.md).
...
![AI ratings in the selector](win-probability/ai-strengths-symmetric-arena-20260919.png)
