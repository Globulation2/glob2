...
void SettingsScreen::buildGeneral()
{
    ...
    if(current==Category::Display) {
        ...
        toggle("gameplay.autosave","Autosave","Save the game automatically about every minute.",s.autosaveGames,[this](int v){globalContainer->settings.autosaveGames=v;commit();});
