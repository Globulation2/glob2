...
#ifndef __GUI_MAP_PREVIEW_H
#define __GUI_MAP_PREVIEW_H
...
/*!
	...
	Each time setMapThumbnail is called a map thumbnail is loaded.
	A map thumbnail is a little image generated by the map editor.
*/
class MapPreview: public RectangularWidget
{
public:
	//! Constructor, takes position, alignment and initial map name
	MapPreview(int x, int y, Uint32 hAlign, Uint32 vAlign);
	//! Constructor, takes position, alignment, initial map name and a tooltip
	...
	//! Returns true if the thumbnail is loaded, false otherwise
