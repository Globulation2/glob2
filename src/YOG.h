...
public:
	...
	enum ExternalStatusState
	{
		...
		YESTS_CONNECTING=10,
		YESTS_YOG_KILLED=12,
		YESTS_CONNECTION_LOST=14,
		YESTS_CONNECTION_REFUSED_PROTOCOL_TOO_OLD=16,
		YESTS_CONNECTION_REFUSED_USERNAME_ALLREADY_USED=18,
		YESTS_CONNECTION_REFUSED_UNEXPLAINED=20
	};
