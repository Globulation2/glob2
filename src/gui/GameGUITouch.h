...
private:
    ...
    std::vector<std::string> pointLines(const std::string& text, double width, double textScale=0.75) const;
    ...
    void drawPointLabel(GAGCore::ViewRect rect, const std::string& text, double textScale=0.75);
