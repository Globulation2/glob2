...
// version 97 seeds guard areas with warrior crowding so free warriors spread between
...
// version 30 guard-area crowding changed where free warriors go; older clients would desync, so they are refused
