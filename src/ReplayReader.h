...
//! and 93 changed the simulation (weighted pathfinding and diagonal timing,
//! hiring-bucket iteration, trapped-colony elimination), so earlier replays would diverge from what
//! happened.
static constexpr Uint16 REPLAY_MINIMUM_VERSION_MINOR = 93;
