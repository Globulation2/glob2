...
//! 93, 94, 95, 96, 97 and 98 changed the simulation (weighted pathfinding and diagonal
...
//! load, route fields invalidated by the map's topology generation, guard-area
//! crowding), so earlier replays would diverge from what happened.
