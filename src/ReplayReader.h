...
//! 93, 94, 95, 96, 97, 99 and 100 changed the simulation (weighted pathfinding and
//! diagonal timing, hiring-bucket iteration, trapped-colony elimination, fetch-job
...
//! guard-area crowding), so earlier replays would diverge from what happened.
static constexpr Uint16 REPLAY_MINIMUM_VERSION_MINOR = 100;
