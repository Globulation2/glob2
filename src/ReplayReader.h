...
//! apportionment, round-trip routing and hiring, Echo building-order ids surviving
//! a load, guard-area crowding), so earlier replays would diverge from what happened.
