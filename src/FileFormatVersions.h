...
//! Pending building sites waiting for units to clear their footprint.
static constexpr int FILE_FORMAT_VERSION_PENDING_CONSTRUCTION = 90;
...
//! Tile::farmArea joins the per-tile area masks in the map section
//! (MapIO.cpp:91, 216).
static constexpr int FILE_FORMAT_VERSION_FARM_AREA = 98;
