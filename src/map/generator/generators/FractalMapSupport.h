...
/// Square garden pools on a jittered lattice through the open land, each ringed by the crops it
/// waters and capped with sand (every third bed timber, the rest wheat): the water these maps
/// need away from their one fractal channel, in the same square-on-a-grid language as the rest
/// of the design. Only stamps clean unreserved
