...
/// point (x, y) within `within` tiles of it, stocked with as many bullets as it holds so it defends
/// from the first tick. Nearest is measured from the footprint's middle, and ties go to the first
