...
private:
	...
	///This is the last placement of terrain, zones, or else, so that the game doesn't use a lot of cpu by small mouse movements
	int lastPlacementX;
	///This is the last placement of terrain, zones, or else, so that the game doesn't use a lot of cpu by small mouse movements
	int lastPlacementY;
	...
	void beginZonePlacement(BrushType type);
