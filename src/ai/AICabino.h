...
namespace Cabino
{
	...
	const bool CabinoStatusUpdate = false;
	...
	class Gradient
	{
		public:
			...
			Gradient(AICabino& team, unsigned sources, unsigned obstacles);
	...
	{
		public:
			BasicDistributedSwarmManager(AICabino& ai);
	...
	///The following deal with AICabinos management of explorers. For most of the time, it just orders the creation of explorers. But eventually,
	...
	///These constants are what fine tune AICabino. There is allot of them.
	///@{
	...
	//These constants are for AICabinos tower controller
	...
	const bool AICabino_DEBUG = false;
	///@}
