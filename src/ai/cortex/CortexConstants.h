...
namespace Cortex
{
	...
	static const int CORTEX_SWARM_WHEAT_ADD_LO= 5;
	static const int CORTEX_SWARM_WHEAT_REM_HI= 15;
	...
	/// harvest, MapGradientGlobal.cpp:135), and depleted tiles are no longer WHEAT at
