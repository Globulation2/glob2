...
void TeamStats::drawStat()
{
	...
	gfx->drawString(textStartPos, startPoxY+16, font, "%s",  strings->getString("[Total/free/seeking]"));
	gfx->drawString(textStartPos, startPoxY+100, font, "%s", strings->getString("[Ok/hungry/wounded]"));
