...
BuildingType g_buildingTypesColony[] = {
	...
	{ .type = "inn",
	  ...
	  .width = 2, .height = 2, .decLeft = -1, .decTop = -1,
	  .maxResource = { /*wood*/0, /*corn*/10, /*papyrus*/0, /*stone*/0, /*algue*/0,
	...
	{ .type = "inn",
	  ...
	  .width = 2, .height = 2, .decLeft = -1, .decTop = -1,
	  .maxResource = { /*wood*/0, /*corn*/30, /*papyrus*/0, /*stone*/0, /*algue*/0,
	...
	{ .type = "inn",
	  ...
	  .maxResource = { /*wood*/7, /*corn*/0, /*papyrus*/0, /*stone*/5 },
	  .maxUnitWorking = 1,
	...
	{ .type = "inn",
	  ...
	  .width = 3, .height = 3, .decLeft = -1, .decTop = -1,
	  .maxResource = { /*wood*/0, /*corn*/50, /*papyrus*/0, /*stone*/0, /*algue*/0,
	...
	{ .type = "hospital",
	  ...
	  .fillable = 1,
	  .width = 2, .height = 2, .decLeft = -1, .decTop = -1,
	  .maxResource = { /*wood*/3, /*corn*/0, /*papyrus*/0, /*stone*/5 },
	  .maxUnitWorking = 1,
...
BuildingType g_buildingTypesMarket[] = {
	...
	{ .type = "market",
	  ...
	  .fillable = 1,
	  .width = 3, .height = 3, .decLeft = -1, .decTop = -1,
	  .maxResource = { /*wood*/4, /*corn*/0, /*papyrus*/0, /*stone*/4 },
	  .maxUnitWorking = 1,
	...
	{ .type = "market",
	  ...
	  .width = 3, .height = 3, .decLeft = -1, .decTop = -1,
	  .maxResource = { /*wood*/0, /*corn*/0, /*papyrus*/0, /*stone*/0, /*algue*/0,
	                    /*fruit0*/200, /*fruit1*/200, /*fruit2*/200 },
	  .maxUnitWorking = 1,
