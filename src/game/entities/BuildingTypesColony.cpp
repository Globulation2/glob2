...
BuildingType g_buildingTypesColony[] = {
	...
	{ .type = "swarm",
	  ...
	  .fillable = 1,
	  .width = 4, .height = 4, .decLeft = -2, .decTop = -2,
	  .unitProductionTime = 150, .resourceForOneUnit = 5,
	  .maxResource = { /*wood*/0, /*wheat*/20 },
	  .maxUnitWorking = 1,
	...
	{ .type = "inn",
	  ...
	  .width = 2, .height = 2, .decLeft = -1, .decTop = -1,
	  .maxResource = { /*wood*/0, /*wheat*/10, /*papyrus*/0, /*stone*/0, /*algue*/0,
	...
	{ .type = "inn",
	  ...
	  .width = 2, .height = 2, .decLeft = -1, .decTop = -1,
	  .maxResource = { /*wood*/0, /*wheat*/30, /*papyrus*/0, /*stone*/0, /*algue*/0,
	...
	{ .type = "inn",
	  ...
	  .maxResource = { /*wood*/7, /*wheat*/0, /*papyrus*/0, /*stone*/5 },
	  .maxUnitWorking = 1,
	...
	{ .type = "inn",
	  ...
	  .width = 3, .height = 3, .decLeft = -1, .decTop = -1,
	  .maxResource = { /*wood*/0, /*wheat*/50, /*papyrus*/0, /*stone*/0, /*algue*/0,
	...
	{ .type = "hospital",
	  ...
	  .fillable = 1,
	  .width = 2, .height = 2, .decLeft = -1, .decTop = -1,
	  .maxResource = { /*wood*/3, /*wheat*/0, /*papyrus*/0, /*stone*/5 },
	  .maxUnitWorking = 1,
...
BuildingType g_buildingTypesMarket[] = {
	...
	{ .type = "market",
	  ...
	  .fillable = 1,
	  .width = 3, .height = 3, .decLeft = -1, .decTop = -1,
	  .maxResource = { /*wood*/4, /*wheat*/0, /*papyrus*/0, /*stone*/4 },
	  .maxUnitWorking = 1,
	...
	{ .type = "market",
	  ...
	  .width = 3, .height = 3, .decLeft = -1, .decTop = -1,
	  .maxResource = { /*wood*/0, /*wheat*/0, /*papyrus*/0, /*stone*/0, /*algue*/0,
	                    /*fruit0*/200, /*fruit1*/200, /*fruit2*/200 },
	  .maxUnitWorking = 1,
