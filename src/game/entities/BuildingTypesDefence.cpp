...
BuildingType g_buildingTypesDefenceTower[] = {
	...
	{ .type = "defencetower",
	  ...
	  .fillable = 1,
	  .width = 2, .height = 2, .decLeft = -1, .decTop = -1,
	  .shootingRange = 5, .shootDamage = 30, .shootSpeed = 5000, .shootRhythm = 1700,
	  .maxBullets = 12, .multiplierStoneToBullets = 3,
	  .maxResource = { /*wood*/0, /*wheat*/0, /*papyrus*/0, /*stone*/4 },
	  .maxUnitWorking = 1,
	...
	{ .type = "defencetower",
	  ...
	  .fillable = 1,
	  .width = 2, .height = 2, .decLeft = -1, .decTop = -1,
	  .maxResource = { /*wood*/10, /*wheat*/0, /*papyrus*/0, /*stone*/14 },
	  .maxUnitWorking = 1,
	...
	{ .type = "defencetower",
	  ...
	  .fillable = 1,
	  .width = 2, .height = 2, .decLeft = -1, .decTop = -1,
	  .shootingRange = 7, .shootDamage = 40, .shootSpeed = 5700, .shootRhythm = 1800,
	...
	{ .type = "defencetower",
	  ...
	  .fillable = 1,
	  .width = 2, .height = 2, .decLeft = -1, .decTop = -1,
	  .maxResource = { /*wood*/8, /*wheat*/0, /*papyrus*/0, /*stone*/14, /*algue*/2 },
	  .maxUnitWorking = 1,
	...
	{ .type = "defencetower",
	  ...
	  .fillable = 1,
	  .width = 2, .height = 2, .decLeft = -1, .decTop = -1,
	  .shootingRange = 9, .shootDamage = 50, .shootSpeed = 7000, .shootRhythm = 1900,
...
BuildingType g_buildingTypesStoneWall[] = {
	...
	{ .type = "stonewall",
	  ...
	  .fillable = 1,
	  .width = 1, .height = 1,
	  .maxResource = { /*wood*/0, /*wheat*/0, /*papyrus*/0, /*stone*/1 },
	  .maxUnitWorking = 1,
