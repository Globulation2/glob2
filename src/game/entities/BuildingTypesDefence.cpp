...
BuildingType g_buildingTypesDefenceTower[] = {
	...
	{ .type = "defencetower",
	  ...
	  .maxResource = { /*wood*/0, /*corn*/0, /*papyrus*/0, /*stone*/4 },
	  .maxUnitWorking = 1,
	...
	{ .type = "defencetower",
	  ...
	  .fillable = 1,
	  .width = 2, .height = 2, .decLeft = -1, .decTop = -1,
	  .maxResource = { /*wood*/10, /*corn*/0, /*papyrus*/0, /*stone*/14 },
	  .maxUnitWorking = 1,
	...
	{ .type = "defencetower",
	  ...
	  .fillable = 1,
	  .width = 2, .height = 2, .decLeft = -1, .decTop = -1,
	  .maxResource = { /*wood*/8, /*corn*/0, /*papyrus*/0, /*stone*/14, /*algue*/2 },
	  .maxUnitWorking = 1,
...
BuildingType g_buildingTypesStoneWall[] = {
	...
	{ .type = "stonewall",
	  ...
	  .fillable = 1,
	  .width = 1, .height = 1,
	  .maxResource = { /*wood*/0, /*corn*/0, /*papyrus*/0, /*stone*/1 },
	  .maxUnitWorking = 1,
