...
// ability levels — racetrack (Walk), swimming pool (Swim), barracks (Attack
...
BuildingType g_buildingTypesUpgrade[] = {
	...
	{ .type = "racetrack",
	  ...
	  .maxResource = { /*wood*/6, /*wheat*/0, /*papyrus*/0, /*stone*/1 },
	  .maxUnitWorking = 1,
	...
	{ .type = "racetrack",
	  ...
	  .maxResource = { /*wood*/10, /*wheat*/0, /*papyrus*/0, /*stone*/5 },
	  .maxUnitWorking = 1,
	...
	{ .type = "racetrack",
	  ...
	  .fillable = 1,
	  .width = 6, .height = 6, .decLeft = -3, .decTop = -3,
	  .maxResource = { /*wood*/15, /*wheat*/0, /*papyrus*/0, /*stone*/5 },
	  .maxUnitWorking = 1,
	...
	{ .type = "swimmingpool",
	  ...
	  .fillable = 1,
	  .width = 6, .height = 6, .decLeft = -3, .decTop = -3,
	  .maxResource = { /*wood*/8, /*wheat*/4, /*papyrus*/0, /*stone*/6, /*algue*/8 },
	  .maxUnitWorking = 1,
	...
	{ .type = "barracks",
	  ...
	  .fillable = 1,
	  .width = 4, .height = 4, .decLeft = -2, .decTop = -2,
	  .maxResource = { /*wood*/3, /*wheat*/0, /*papyrus*/0, /*stone*/10 },
	  .maxUnitWorking = 1,
	...
	{ .type = "barracks",
	  ...
	  .fillable = 1,
	  .width = 4, .height = 4, .decLeft = -2, .decTop = -2,
	  .maxResource = { /*wood*/10, /*wheat*/0, /*papyrus*/0, /*stone*/10 },
	  .maxUnitWorking = 1,
	...
	{ .type = "school",
	  ...
	  .maxResource = { /*wood*/7, /*wheat*/0, /*papyrus*/0, /*stone*/0, /*algue*/2 },
	  .maxUnitWorking = 1,
	...
	{ .type = "school",
	  ...
	  .fillable = 1,
	  .width = 2, .height = 2, .decLeft = -1, .decTop = -1,
	  .maxResource = { /*wood*/5, /*wheat*/0, /*papyrus*/0, /*stone*/5, /*algue*/12 },
	  .maxUnitWorking = 1,
	...
	{ .type = "school",
	  ...
	  .fillable = 1,
	  .width = 2, .height = 2, .decLeft = -1, .decTop = -1,
	  .maxResource = { /*wood*/7, /*wheat*/4, /*papyrus*/0, /*stone*/12, /*algue*/10 },
	  .maxUnitWorking = 1,
