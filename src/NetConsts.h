...
enum OrderTypes
{
	...
	ORDER_NULL=51,
	ORDER_QUITED=52, // Only for communication channel between NetGame and GameGui.
	ORDER_DECONNECTED=53, // Only for communication channel between NetGame and GameGui.
