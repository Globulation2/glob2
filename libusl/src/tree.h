...
struct Node
{
	...
	void emit(ThunkPrototype* thunk, CodeGen& cg, Code* code);
	virtual void generate(ScopePrototype* scope, CodeGen& cg) = 0;
...
struct ExpressionNode: Node
{
	...
	virtual void generate(ScopePrototype* thunk, CodeGen& cg);
	virtual void generate(ThunkPrototype* thunk, CodeGen& cg) = 0;
};
...
struct ConstNode: ExpressionNode
{
	...
	virtual void generate(ThunkPrototype* thunk, CodeGen& cg);
	virtual void dumpSpecific(std::ostream &stream, unsigned indent) const;
...
struct DecNode: Node
{
	...
	virtual ~DecNode();
	void declare(ScopePrototype* scope, CodeGen& cg);
	virtual void generate(ThunkPrototype* thunk, CodeGen& cg);
	virtual void generate(ScopePrototype* scope, CodeGen& cg);
	virtual void dumpSpecific(std::ostream &stream, unsigned indent) const;
...
struct BlockNode: ExpressionNode
{
	...
	virtual void dumpSpecific(std::ostream &stream, unsigned indent) const;
	virtual void generate(ThunkPrototype* thunk, CodeGen& cg);
	virtual void generateMembers(ScopePrototype* scope, CodeGen& cg) = 0;
...
struct ExecutionBlock: BlockNode
{
	...
	virtual void generateMembers(ScopePrototype* scope, CodeGen& cg);
};
