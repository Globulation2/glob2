...
BASE=Path('/Users/bradley/glob2/output/maxima-conversion-fixed-restart');CONFIG='/Users/bradley/glob2/output/maxima-live-controls-v21/ssh-config'
ROOT='/home/bradley/glob2-maxima-conversion-fixed';CAMPAIGN=ROOT+'/output/qualification'
def run(host,cpu):
