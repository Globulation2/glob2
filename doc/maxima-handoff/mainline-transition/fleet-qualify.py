...
BASE=Path('/Users/bradley/glob2/output/maxima-mainline-transition');CONFIG='/Users/bradley/glob2/output/maxima-live-controls-v21/ssh-config'
ROOT='/home/bradley/glob2-maxima-mainline-100k-final';CAMPAIGN=ROOT+'/output/qualification-100k'
def run(host,cpu):
