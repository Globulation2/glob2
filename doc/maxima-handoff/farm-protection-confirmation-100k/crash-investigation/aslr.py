...
out=root/'output/crash-77cfd-aslr';out.mkdir(exist_ok=False)
...
cmd=['taskset','-c','5','gdb','-batch','-ex','set disable-randomization off','-ex','set pagination off','-ex','run','-ex','bt','-ex','info registers','--args',*args]
