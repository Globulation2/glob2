...
out=root/'output/crash-77cfd-perturb';out.mkdir(exist_ok=False)
...
env={k:v for k,v in os.environ.items() if not k.startswith(('GLOB2_MAXIMA','GLOB2_NICOWAR_V3'))};env.update(MALLOC_PERTURB_='165',OMP_NUM_THREADS='1',OPENBLAS_NUM_THREADS='1',MKL_NUM_THREADS='1')
